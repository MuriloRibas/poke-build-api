...
import { PickTrainer } from '../pages/pick_trainer'
...
const App = () => {
  ...
  const requestAllData = async () =>{
    const getTeams = await Axios.get('http://localhost:3000/api/v1/teams')
    const getTrainers = await Axios.get('http://localhost:3000/api/v1/trainers')
